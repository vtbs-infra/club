...
const errorMessages: Readonly<Record<string, string>> = {
  ...
  BILIBILI_AUTH_REQUIRED: 'B站验证服务暂不可用，请稍后重试或联系平台管理员。',
  BILIBILI_SESSION_CONFLICT: '读取账号已发生变化，请刷新页面后重新操作。',
  BILIBILI_LOGIN_NOT_FOUND: '扫码任务已失效，请重新申请二维码。',
  BILIBILI_UPSTREAM_UNAVAILABLE: '暂时无法连接 B站，系统将稍后重试。',
  BILIBILI_UPSTREAM_REJECTED: 'B站暂时拒绝了请求，请稍后重试。',
  BILIBILI_INVALID_RESPONSE: 'B站返回的信息不完整，请稍后重试。',
  BILIBILI_REFRESH_UNCERTAIN: '续期结果无法确认，请重新扫码登录读取账号。',
  BILIBILI_CREDENTIALS_UNREADABLE: '已保存的读取凭据无法解密，请检查密钥配置或重新扫码。',
