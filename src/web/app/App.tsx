...
const SiteEditorPage = lazy(() =>
  import('../pages/SiteEditorPage').then(({ SiteEditorPage: page }) => ({ default: page })),
);
...
const router = createBrowserRouter([
  ...
  {
    element: (
      <Suspense fallback={<main className="shell page-state">Loading editor…</main>}>
        <SiteEditorPage />
      </Suspense>
    ),
    path: '/platform/site',
